...
import { toggleLike, deletePost, type IPost } from '../store/slices/feedSlice';
import { useAuth } from '../context/AuthContext';
import { Heart, Trash2, MapPin, Tag } from 'lucide-react';
...
export const FeedCard: React.FC<FeedCardProps> = ({ post }) => {
  ...
  return (
    <div className="bg-white dark:bg-dark-800 border border-dark-200 dark:border-dark-700 p-5 rounded-2xl transition duration-200 hover:shadow-md animate-slide-up">
      ...
      {/* Footer / Actions */}
      <div className="mt-4 pt-3 border-t border-dark-150 dark:border-dark-700 flex items-center">
        <button
          onClick={handleLike}
